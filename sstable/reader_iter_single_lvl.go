...
func (i *singleLevelIterator) init(
	...
	err = i.index.InitHandle(i.cmp, r.Split, indexH, transforms, r.tableFormat.UsesValuePrefix())
	if err != nil {
...
func (i *singleLevelIterator) loadBlock(dir int8) loadBlockResult {
	...
	i.err = i.data.InitHandle(i.cmp, i.reader.Split, block, i.transforms, i.reader.tableFormat.UsesValuePrefix())
	if i.err != nil {
