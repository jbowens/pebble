...
type InternalIterator interface {
	...
	SeekGE(key []byte, flags SeekGEFlags) (*InternalKey, func() LazyValue)
	...
	SeekPrefixGE(prefix, key []byte, flags SeekGEFlags) (*InternalKey, func() LazyValue)
	...
	// the upper bound.
	SeekLT(key []byte, flags SeekLTFlags) (*InternalKey, func() LazyValue)
	...
	First() (*InternalKey, func() LazyValue)
	...
	Last() (*InternalKey, func() LazyValue)
	...
	Next() (*InternalKey, func() LazyValue)
	...
	NextPrefix(succKey []byte) (*InternalKey, func() LazyValue)
	...
	Prev() (*InternalKey, func() LazyValue)
