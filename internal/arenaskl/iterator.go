...
func (it *Iterator) First() (*base.InternalKey, func() base.LazyValue) {
...
func (it *Iterator) Last() (*base.InternalKey, func() base.LazyValue) {
...
func (it *Iterator) Next() (*base.InternalKey, func() base.LazyValue) {
...
// otherwise.
func (it *Iterator) NextPrefix(succKey []byte) (*base.InternalKey, func() base.LazyValue) {
...
// iterator is pointing at a valid entry, and (nil, nil) otherwise.
func (it *Iterator) Prev() (*base.InternalKey, func() base.LazyValue) {
...
func (it *Iterator) value() base.LazyValue {
	return base.MakeInPlaceValue(it.nd.getValue(it.list.arena))
}
