...
// SeekGE seeks to the newest span that contains or is past the target
...
// after calling SeekGE and may not be pointing at the returned span.
...
func SeekLE(cmp base.Compare, iter base.InternalIterator, key []byte, snapshot uint64) Span {
	...
	//     return the span [j,n)#1. Because the end key of the span
